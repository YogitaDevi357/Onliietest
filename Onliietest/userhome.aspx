    ...
    <table style="width: 100%" bgcolor="#CC99FF">
        <tr>
            <td class="style10">
                        ...
                        <td class="style11">
        <asp:Label ID="user" runat="server" ForeColor="Maroon" 
            style="font-size: xx-large; font-weight: 400; font-style: italic; font-family: 'Bell MT';"></asp:Label>
                        </td>
                        <td class="style12">
            <asp:Button ID="btn_logout" runat="server" Text="Log Out" BorderColor="Black" />
                    ...
                    <tr>
                        <td style="font-family: 'Blackadder ITC'; font-size: 45px; color: #006666;" >
