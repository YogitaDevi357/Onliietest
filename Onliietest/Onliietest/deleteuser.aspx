    ...
    <table  style="margin-bottom: 0px" align="center" 
        ...
        <tr>
            <td colspan="2" 
                ...
                style=" color: #0000FF; font-size: xx-large; font-family: Arial; font-style: italic; text-align: center" 
                class="style6">
                &nbsp;&nbsp; </td>
            <td colspan="2" 
                
                style=" width: 365px;  color: #0000FF; font-size: xx-large; font-family: Arial; font-style: italic; text-align: center">
                &nbsp; DELETE USER </td>
        </tr>
        <tr>
            <td style=" width:365px;  font-weight: bold; font-size: large;">
                ENTER User Name</td>
            <td colspan="2">
